...
Elasticsearch 的查询表达式相当灵活，((("relevance", "controlling", "manipulating relevance with query structure")))((("queries", "manipulating relevance with query structure")))可以通过在查询结构中，移动查询语句的位置来或多或少的改变它们的重要性，比如，设想下面这个查询：
